...
const translations = {
    ...
    home: {
      ...
      tools: {
        ...
        vaultwardenTitle: '🔐 SorolaVault',
        vaultwardenDesc: 'Avaa Vaultwarden-salasanaholvi kutsutuille käyttäjille',
    ...
    help: {
      ...
      tools: {
        ...
        vaultwarden: {
          description: 'Avaa SorolaVault-salasanaholvi selaimessa kutsutuille käyttäjille.',
          step1: 'Avaa SorolaVault-painike sovelluksesta.',
          step2: 'Kirjaudu sisään Vaultwarden-tunnuksillasi.',
          step3: 'Hallitse salasanoja turvallisesti selaimessa.',
        },
      },
    },
    jsonFormatter: {
    ...
    changelog: {
      title: '⚡ Muutosloki',
      intro: 'Täältä löydät uusimmat muutokset sorola.fi-palveluihin ja Android-sovellukseen.',
      entries: {
        latest: {
          date: '4.8.2026',
          title: 'Uusia ohjeita ja tietosuojaselosteita',
          item1: 'Lisätty uusia kattavia käyttöohjeita palveluiden ja IT-työkalujen käyttöön.',
          item2: 'Päivitetty ja lisätty asianmukaiset tietosuojaselosteet verkkotyökaluille ja palveluille.',
        },
        jsonFormatter: {
          date: '3.8.2026',
          title: 'JSON-muotoilija',
          item1: 'Lisätty uusi JSON-muotoilija ja validaattori edistyneisiin työkaluihin.',
          item2: 'Työkalu toimii täysin paikallisesti ilman tietojen lähettämistä palvelimelle.',
        },
        grouping: {
          date: '1.8.2026',
          title: 'Työkalujen ryhmittely ja webtools.sorola.fi',
          item1: 'Työkalut ryhmiteltiin selkeämmin perustyökaluihin ja edistyneisiin työkaluihin.',
          item2: 'Avattiin uusi webtools.sorola.fi-aliverkkotunnus verkkotyökalukokoelmaa varten.',
        },
        app: {
          date: '31.7.2026',
          title: 'Android-sovelluksen julkaisu',
          item1: 'Sorolan Android-sovellus julkaistiin helpottamaan perustyökalujen käyttöä mobiilissa.',
        },
      },
    },
    privacy: {
      ...
      tools: {
        ...
        vaultwarden: {
          title: '🔐 SorolaVault',
          summary: 'SorolaVault avataan selaimessa erillisenä Vaultwarden-palveluna kutsutuille käyttäjille.',
          details: 'Vaultwardenin tietojen käsittely tapahtuu kyseisessä palvelussa sen omien suojausten mukaisesti. Holvi on tarkoitettu vain kutsutuille käyttäjille.',
        },
      },
    },
  },
  en: {
    ...
    home: {
      ...
      tools: {
        ...
        vaultwardenTitle: '🔐 SorolaVault',
        vaultwardenDesc: 'Open the Vaultwarden password vault for invited users',
    ...
    help: {
      ...
      tools: {
        ...
        vaultwarden: {
          description: 'Open the SorolaVault password vault in your browser for invited users.',
          step1: 'Open SorolaVault from the app.',
          step2: 'Sign in with your Vaultwarden credentials.',
          step3: 'Manage your passwords securely in the browser.',
        },
      },
    },
    jsonFormatter: {
    ...
    changelog: {
      title: '⚡ Changelog',
      intro: 'Here you can find the latest changes to sorola.fi services and the Android app.',
      entries: {
        latest: {
          date: '4 Aug 2026',
          title: 'New guides and privacy policies',
          item1: 'Added new comprehensive usage guides for services and IT tools.',
          item2: 'Updated and added appropriate privacy policies for web tools and services.',
        },
        jsonFormatter: {
          date: '3 Aug 2026',
          title: 'JSON Formatter',
          item1: 'Added a new JSON formatter and validator to the advanced tools.',
          item2: 'The tool works fully locally without sending data to a server.',
        },
        grouping: {
          date: '1 Aug 2026',
          title: 'Tool grouping and webtools.sorola.fi',
          item1: 'Tools were grouped more clearly into basic and advanced tools.',
          item2: 'Opened the new webtools.sorola.fi subdomain for the web tools collection.',
        },
        app: {
          date: '31 Jul 2026',
          title: 'Android app release',
          item1: 'Released the Sorola Android app to make the basic tools easier to use on mobile.',
        },
      },
    },
    privacy: {
      ...
      tools: {
        ...
        vaultwarden: {
          title: '🔐 SorolaVault',
          summary: 'SorolaVault opens in your browser as a separate Vaultwarden service for invited users.',
          details: 'Vaultwarden data processing happens in that service under its own protections. The vault is intended only for invited users.',
        },
      },
    },
  },
