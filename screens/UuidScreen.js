...
const styles = StyleSheet.create({
  ...
  helperText: { color: '#a0aec0', marginBottom: 20, fontSize: 14, lineHeight: 20 },
  resultBox: { backgroundColor: '#0b0d13', borderWidth: 1, borderColor: '#4ade80', padding: 20, borderRadius: 8, marginBottom: 20 },
